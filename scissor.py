...
class RockPaperScissorsApp:
    def __init__(self, root):
        ...
        self.rock_radio = tk.Radiobutton(root, text="Rock", font=("Arial", 16), variable=self.user_choice_var, value="rock")
        self.rock_radio.pack(anchor=tk.W)
        self.rock_radio.place(x=200, y=53)
        self.rock_radio.pack(pady=10)

        self.paper_radio = tk.Radiobutton(root, text="Paper", font=("Arial", 16), variable=self.user_choice_var, value="paper")
        self.paper_radio.pack(anchor=tk.W)
        self.paper_radio.place(x=200, y=53)
        self.paper_radio.pack(pady=10)

        self.scissors_radio = tk.Radiobutton(root, text="Scissors", font=("Arial", 16), variable=self.user_choice_var, value="scissors")
        self.scissors_radio.pack(anchor=tk.W)
        self.scissors_radio.place(x=200, y=53)
        self.scissors_radio.pack(pady=10)

        # Button to play the game
        self.play_button = tk.Button(root, text="Play", font=("Arial", 16), command=self.play)
